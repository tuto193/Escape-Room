...
[RequireComponent(typeof(CharacterController), typeof(PlayerInputManager), typeof(AudioSource))]
public class PlayerCharacterController : MonoBehaviour {
    ...
    // Variables necessary to interact with objects in the world
    public float distanceToSee;
    private RaycastHit _ObjectInSight;
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<PlayerInputManager, PlayerCharacterController>(m_InputManager,
            this, gameObject);
    ...
    {
        // deal with UI stuff
        if (m_InputManager.GetSubmitInputDown()) {
            GameManager.Instance.HandleIntro();
        }
        ...
        // Check if there is anything in our line of sight
        if (Physics.Raycast(this.transform.position, this.transform.forward, out _ObjectInSight, distanceToSee)) {
            if (m_InputManager.GetFireInputDown()) {
                GameObject seenObject = _ObjectInSight.collider.gameObject;
                ...
                switch(object_tag) {
                    ...
                    case "Key":
                        // End Game (?)
                        GameManager.Instance.HandleClickedKey();
                        break;
                }
            }
        }
    ...
    void HandleCharacterMovement() {
        // horizontal character rotation
        {
            ...
            transform.Rotate(
                new Vector3(0f, (m_InputManager.GetLookInputsHorizontal() * RotationSpeed ),
                    0f), Space.Self);
        }
        ...
        // vertical camera rotation
        {
            ...
            m_CameraVerticalAngle += m_InputManager.GetLookInputsVertical() * RotationSpeed;
        ...
        // character movement handling [START]
        {
